...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Make direct API call to Supabase (no SDK needed)
    ...
    html: `
      ...
      <body>
        ...
        <div class="content">
          ...
          <p>We'll keep you updated on our progress. In the meantime, feel free to reply to this email with any questions or feedback!</p>
          
          <p>Take care,<br>
          <strong>The Serenica Team</strong></p>
        </div>
        
        <div class="footer">
          <p>You're receiving this because you signed up for the Serenica waitlist.</p>
          <p>© ${new Date().getFullYear()} Serenica. All rights reserved.</p>
        </div>
      </body>
      </html>
    `,
